        ...
        <div class="card">
            <div class="card-header">
                <h2>
                 ...
                 <div class="ml-auto">
                      <?= $this->Html->link(__('Nouvelle entreprise'), ['action' => 'add'], [
                ...
                <table class="data-table">
                    <thead>
                        <tr>
                            <th><?= __('#') ?></th>
                            <th><?= __('Nom') ?></th>
                            <th><?= __('Gestionnaire') ?></th>
                            <th><?= __("Ville d'origine") ?></th>
                            <th><?= __('Téléphone') ?></th>
                            <th><?= __('Email') ?></th>
                       ...
                       <?php foreach ($companies as $company): ?>
                        <tr>
                            ...
                            <td><?= h($company->email) ?></td>
                                <td class="actions">
                                    <?= $this->Html->link(__('<i class="fas fa-edit" style="color:#000;"></i>'), ['action' => 'edit', $company->id], ['escape' => false,'title'=>'Modifier']) ?>
                                    <?= $this->Form->postLink(
                                        '<i class="fas fa-trash-alt" style="color:#dc3545;"></i>',
                                        ['action' => 'delete', $company->id],
                                        [
                                            'confirm' => __('Vous etes sur de vouloir supprimer le COM$company  de {0}?', $company->name),
                                            'escape' => false,
                                            'title' => 'Supprimer',
                                        ]
                                        ) ?>
