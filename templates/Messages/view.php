        ...
        <div class="messages view content">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td><?= $message->hasValue('calibration_record') ? $this->Html->link($message->calibration_record->id, ['controller' => 'CalibrationRecords', 'action' => 'view', $message->calibration_record->id]) : '' ?></td>
                </tr>
                <tr>
                    <th><?= __('Id') ?></th>
                ...
                <tr>
                    <th><?= __('Team Id') ?></th>
                    <td><?= $message->team_id === null ? '' : $this->Number->format($message->team_id) ?></td>
                </tr>
                <tr>
                    <th><?= __('Created') ?></th>
