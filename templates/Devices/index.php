        ...
        <div class="card">
            <div class="card-header">
                <h2>
                 ...
                 <div class="ml-auto">
                      <?= $this->Html->link(__('Nouveau appareil'), ['action' => 'add'], [
                    ...
                    <thead>
                        <tr>
                            ...
                            <th><?= __('Nom appareil') ?></th>
                             <th><?= __('Code appareil') ?></th>
                            <th><?= __('Fabricant') ?></th>
                            <th><?= __("Date d'aquisition") ?></th>
                    ...
                    <tbody id="cashbox-list-body">
                       <?php foreach ($devices as $device): ?>
                            <tr>
                                ...
                                <td><?= h($device->created->nice()) ?></td>
                                <td class="actions">
                                    <?= $this->Html->link(__('<i class="fas fa-edit" style="color:#000;"></i>'), ['action' => 'edit', $device->id], ['escape' => false,'title'=>'Modifier']) ?>
                                    <?= $this->Form->postLink(
                                        '<i class="fas fa-trash-alt" style="color:#dc3545;"></i>',
                                        ['action' => 'delete', $device->id],
                                        [
                                            'confirm' => __("Vous etes sur de vouloir supprimer l'appareil {0}?", $device->name),
                                            'escape' => false,
                                            'title' => 'Supprimer',
                                        ]
                                        ) ?>
