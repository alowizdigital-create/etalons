    ...
    <div id="custom-alert" class="modal-backdrop" onclick="this.classList.remove('active')">
        ...
        <div class="card">
            <div class="card-header">
                <h2>
                    <i data-lucide="list-checks"></i> ETALONNAGES
                </h2>
                 <div class="ml-auto">
                      <?= $this->Html->link(__('Nouveau étalonnage'), ['action' => 'add'], [
            ...
            <div class="table-container" id="cashbox-table-container">
                <table class="data-table">
                    <thead>
                        <tr>
                            <th><?= __('#') ?></th>
                            <th><?= __('Nom appareil') ?></th>
                            <th><?= __('Entreprise') ?></th>
                            <th><?= __("Agent") ?></th>
                            <th><?= __("Date d'étalonnage") ?></th>
                             <th><?= __("Validité") ?></th>
                    ...
                    <tbody id="cashbox-list-body">
                        <?php foreach ($calibrationRecords as $calibrationRecord): ?>
                            <tr>
                                <td></td>
                               ...
                               <td><?= h($calibrationRecord->next_calibration_date) ?></td>
                                <td class="actions">
                                      <?= $this->Html->link(__('<i class="fas fa-edit" style="color:#000;"></i>'), ['action' => 'edit', $calibrationRecord->id], ['escape' => false,'title'=>'Modifier']) ?>
                                    <?= $this->Form->postLink(
                                        '<i class="fas fa-trash-alt" style="color:#dc3545;"></i>',
                                        
                                        ['action' => 'delete', $calibrationRecord->id],
                                        [
                                            'confirm' => __('Etes vous sûr de vouloir supprimer cet  enregistrement ?', $calibrationRecord->name),
                                            'escape' => false,
                                            'title' => 'Supprimer',
                                        ]
                                        ) ?>
...
<footer class="main-footer" style="position: fixed; bottom: 0; left: 0; width: 100%; z-index: 1030; background: #f8f9fa; padding: 10px 20px; border-top: 1px solid #dee2e6;">
  ...
  <strong>Copyright &copy; 2025 <a href="#" style="color:var(--aa-primary);border-radius:8px;">Hervé Ronsard FOTSO 
Ingénieur Géomaticien-Informaticien </a></strong> Tous droits réservés.
