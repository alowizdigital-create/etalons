        ...
        <div class="card">
            <div class="card-header">
                <h2>
                 ...
                 <div class="ml-auto">
                      <?= $this->Html->link(__('Nouveau agent'), ['action' => 'add'], [
                     ...
                     <?php foreach ($agents as $agent): ?>
                            <tr>
                               ...
                               <td><?= h($agent->registration_number) ?></td>
                                ...
                                <td><?= h($agent->phone) ?></td>
                                <td class="actions">
                                    <?= $this->Html->link(__('<i class="fas fa-edit" style="color:#000;"></i>'), ['action' => 'edit', $agent->id], ['escape' => false,'title'=>'Modifier']) ?>
                                    <?= $this->Form->postLink(
                                        '<i class="fas fa-trash-alt" style="color:#dc3545;"></i>',
                                        ['action' => 'delete', $agent->id],
                                        [
                                            'confirm' => __('Vous etes sur de vouloir supprimer le agent  de {0}?', $agent->name),
                                            'escape' => false,
                                            'title' => 'Supprimer',
                                        ]
                                        ) ?>
