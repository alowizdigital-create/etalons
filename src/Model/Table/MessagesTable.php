 ...
 * Messages Model
 *
 * @property \App\Model\Table\CalibrationRecordsTable&\Cake\ORM\Association\BelongsTo $CalibrationRecords
 *
...
class MessagesTable extends Table
{
    ...
    public function validationDefault(Validator $validator): Validator
    {
        ...
        $validator
            ->integer('calibration_record_id')
            ->notEmptyString('calibration_record_id');
