 ...
 public function index()
{
    ...
    {
        $device = $this->Devices->get($id, contain: ['CalibrationRecords']);
    ...
    public function add()
    {
        ...
        if ($this->request->is('post')) {
            ...
            $device->uuid =  Text::uuid();
            $device->create_uid =  $this->currentUser->id;
            $device->write_uid =  $this->currentUser->id;
