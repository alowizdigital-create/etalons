...
class AgentsController extends AppController
{
    ...
    {
        $query = $this->Agents->find();
        $agents = $this->paginate($query);
    ...
    {
        $agent = $this->Agents->get($id, contain: ['CalibrationRecords']);
    ...
    public function add()
    {
        ...
        if ($this->request->is('post')) {
            ...
            $agent->create_uid = $this->currentUser->id;
            $agent->write_uid = $this->currentUser->id;
            $agent->uuid = Text::uuid();
    ...
    {
        $agent = $this->Agents->get($id, contain: []);
